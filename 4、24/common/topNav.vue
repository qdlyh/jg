...
export default {
    ...
    methods: {
        navBtn(data) {
            ...
            //     sessionStorage.setItem('navParent', data.uuid);  /* 展开的父ID */
            // } else {
            //     sessionStorage.setItem('navFind', data.uuid);  /* 展开的子ID */
            // }
            localStorage.setItem('titleId', data.uuid);       /* 分页请求id */
            localStorage.setItem('labelTitle', data.label);   /* 分页标题 */

            this.$emit('navId', data); //主动触发navId方法，'uuid'为向父组件传递的数据
            this.$router.push(data.url);
        },
        // btns(items) {
        //     sessionStorage.setItem('navParent', items.uuid);  /* 展开的父ID */
        ...
        // btn(item, items) {
        //     sessionStorage.setItem('navParent', items.uuid);  /* 展开的父ID */
        //     sessionStorage.setItem('navFind', item.uuid);  /* 展开的子ID */
