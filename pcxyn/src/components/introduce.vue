...
export default {
    ...
    mounted() {
        this.$ajax({
            method: 'get',
            url: this.psta + '/rest/pc/getPcDownloadUrl?type=pc',
        })
            .then(response => {
                //console.log(response)
                this.downloadPc = response.data.PcDownloadUrl.outerurl;
                //console.log(this.downloadPc)
            })
            .catch(error => {
                console.log(error);
                //alert('网络错误，不能访问');
