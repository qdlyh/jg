                    ...
                    <div v-show="stepOne" class="step-one">
                        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm form">
                            <el-form-item label="培训项目" prop="project">
                                <el-input v-model.trim="ruleForm.project" style="width:380px;"></el-input>
                            </el-form-item>
                            <el-form-item label="您的姓名" prop="name">
                                <el-input v-model.trim="ruleForm.name" style="width:380px;"></el-input>
                            </el-form-item>
                            ...
                            <div class="checked">
                                ...
                                <span @click="centerDialogVisible = true">阅读条款</span>
                            </div>
                            <el-form-item>
...
export default {
    ...
    mounted() {
        ...
        this.$ajax({
            method: 'get',
            url: this.psta + '/rest/pc/getPcBgImage',
        })
            .then(response => {
                // console.log(response)
                this.imgae = response.data.PcBgImage.image;
                console.log(this.imgae)
            })
            .catch(error => {
                console.log(error);
                //alert('网络错误，不能访问');
