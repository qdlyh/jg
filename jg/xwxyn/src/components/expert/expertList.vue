...
export default {
  ...
  activated() {
    ...
    this.isShow = (this.$store.state.forum == null) ? this.$store.state.forum = Number(sessionStorage.getItem('forum')) : this.$store.state.forum;
