...
export default {
    ...
    mounted() {
        this.isHave = false;
        this.isShow = (this.$store.state.yzList == undefined) ? this.$store.state.yzList = Number(sessionStorage.getItem('yzList')) : this.$store.state.yzList;
    ...
    methods: {
        ...
        onItemClick(index) {
            if (this.isShow != index) {
                this.isShow = index;
                this.$store.commit('yzList', index);
