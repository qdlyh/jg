...
export default {
    ...
    methods: {
        ...
        submit() {
            let formData = JSON.parse(sessionStorage.getItem("formData")); //后台用作判断是否申请资料
            ...
            if (have) {
                ...
                formData.append('settingId', value);
                formData.append('scope', scope);
                formData.append('businessAddress', businessAddress);
                formData.append('files', this.Image3);
                formData.append('files', this.Image0);
